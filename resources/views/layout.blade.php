  ...
  border-radius: 5px;
    ...
    <div>
          ...
          <nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
            <div class="container-fluid">
              <a class="navbar-brand " href="{{url('/truyen-hay')}}">
                <i class="fa fa-leanpub" style="margin-right: 10px" aria-hidden="true"></i>STORYHUB </a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <!-- tim kiem -->
                  ...
                  <button class="btn btn-warning text-light" style="margin-left: 20px"  type="submit">
                      <i class="fa fa-search" aria-hidden="true"></i>
                  </button>
                  </div>
                    <div id="search_ajax" style="margin-top: 5px"></div>
                    <div id="search_ajax" style="margin-bottom: 5px"></div>
                  </form>
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                      <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <div class="welcome" style="background-color: #fff">
            <p class="marquee">
              <i class="fa fa-book" aria-hidden="true" style="margin-right: 10px"></i> StoryHub  xin  chào !   Chúc  các  bạn  đọc  truyện  vui  vẻ  <i class="fa fa-heart" aria-hidden="true" style="margin-left: 10px"></i>
            </p>
          </div>
          ...
          <div style="margin-top: 15px">
            ...
            <div class="d-flex justify-content-between align-content-center m-4">
              <div class="col col-sm-10">StoryHub - Đọc truyện online, đọc truyện chữ, truyện hay. Website luôn cập nhật những bộ truyện mới thuộc các thể loại đặc sắc như truyện tiểu thuyết, truyện trinh thám, hay truyện ngôn tình một cách nhanh nhất. Hỗ trợ mọi thiết bị như di động và máy tính bảng.</div>
